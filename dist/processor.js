...
const fetchSource = async (url) => {
    const result = await fetch(url).then(async (res) => await res.text()).catch(error => console.error(error));
    return result ?? '';
};
/**
 * 解析源数据为目标数据集
...
const generateJSON = (payload, dir = 'out', fileName = 'all') => {
